...
- When you "publish" your plot (this could be including it in a report for a class), it needs to be **clearly labeled**
  - Whoever is reading your report won't know what "gdpPercap" means

- To demonstrate, let's go back to the life expectancy vs. GDP plot

- Use the `labs()` function to adjust the labels
