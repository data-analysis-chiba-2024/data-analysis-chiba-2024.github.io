...
- Please sit with members of your team and choose a dataset and team name
...
- To avoid **merge conflicts** (incompatible changes to the same file made by different people) **make a copy** of the final report file **for each team member** to work on.
  - For example, `final-report-jn.Qmd`
...
- There is some text in the `.qmd` file. Edit it to match your dataset and team members.
