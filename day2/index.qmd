...
A PAT is a "Personal Access Token". It is like a more secure password.
...
- Look over the scopes; “repo”, “user”, and “workflow” are recommended. Recommended scopes will be pre-selected if you used create_github_token().
...
- Using the default expiration date is recommended for security
